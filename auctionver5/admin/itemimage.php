...
<table id="tableOutput">
	...
	<tbody>
		<?php
          ...
          $numimg = mysql_num_rows(mysql_query("SELECT * FROM tbl_Images where item_ID = $itemid"))
					?>
					<tr>
            ...
            <td><?php echo $numimg?></td>
						<td><button class="addimg btn black white-text" id="<?php echo $get_row['item_ID']?>" onclick="viewContent(<?php echo $get_row['item_ID']?> )">Add Image</button></td>
					</tr>
					<?php
				}
			}
