...
<a class="btn blue-grey darken-3 white-text" target="frame"  style="width:100%;height:20%;" href="uti_delivery_fee.php"><br>Delivery Fees</a><br><br>
...
<iframe name="frame"  src="uti_delivery_fee.php" style=" position: absolute; left: 24%; top: 15%; height: 80%; width:73%;">
	</iframe>
</body>
